...
function getIngredients(ingredients) {
  ...
  column.classList.add('ingredients_detailled_bloc');

  let ingredientName;

  for (const ingredient of ingredients) {
    ingredientName = document.createElement('p');
    ingredientName.setAttribute('data_ingredient', ingredient.ingredient);
...
function getRecipeCard(data) {
  ...
  blankImage.classList.add('blank_space');
  ...
  spanIcon.className = 'duration_icon';
  ...
  hidden.classList.add('is_hidden');
